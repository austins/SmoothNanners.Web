...
and bundled with Vite. The app is statically generated and deployed to GitHub Pages. The website currently is simple
single page (+page for 404) and can be modified to run as a server instance with more content in the future. This also
serves as a template for future Razor Pages projects.
